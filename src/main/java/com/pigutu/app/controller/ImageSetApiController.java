...
@Controller
@RequestMapping("/api")
public class ImageSetApiController {
    @Autowired
    ...
    @ResponseBody
    public List<ImageSetEntity> findImageById(HttpServletRequest request, Model model, @PathVariable(value = "id") int id, @PathVariable(value = "page") int page) {
