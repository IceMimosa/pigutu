    ...
    <ul class="topbar">
        ...
        <li class="nav"><span class="icon" onclick="viewnav();"></span>
            <ul class="menu" id="menu">
                <li><i class="icon"></i><a href="//m.pigutu.com/index/1">首页</a></li>
    ...
    <#list categorys as category>
        <li><h2><a href="${mUrl}beauty/${category.getParameter()}/1">${category.getTitle()}</a></h2>
            <div class="pic"><a href="${mUrl}beauty/${category.getParameter()}/1"><img
                    src="//img.pigutu.com/${category.getPath()}/mindex"
...
<div class="footer">
    <div class="tool"><span><a href="//www.pigutu.com/">去电脑版</a></span><span class="gotop"><a
            href="//m.pigutu.com/#">返回顶部</a></span></div>
    <div class="copyright">Copyright © 2017 屁股图 pigutu.com</div>
</div>
<div id="topbtn" onclick="goscrolltop();"></div>
<script type="text/javascript" src="//img.pigutu.com/js/mimage.js"></script>
